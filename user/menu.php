<ul class="sidebar-menu">
    <li class="menu-header bg-warning"></li>
		...
		<?php } else { ?>
		<li><a class="nav-link" href="#"><i class="fas fa-address-card   "></i> <span>Daftar Ulang</span></a></li>
		<?php } ?>

		<?php if ($siswa['status'] == 1) { ?>
			<li><a class="nav-link" href="?pg=bayar"><i class="fas fa-funnel-dollar fa-fw"></i> <span>Pembayaran</span></a></li>
		<?php } else { ?>
			<li><a class="nav-link" href="#"><i class="fas fa-funnel-dollar fa-fw"></i> <span>Pembayaran</span></a></li>
		<?php } ?>
